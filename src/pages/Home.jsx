...
const Home = () => {
  ...
  return (
    <div className="bg-white font-serif text-gray-800">
      ...
      {/* 1. Top Breadcrumb Bar (Matching Image 1) */}
      ...
      <div className="max-w-3xl mx-auto pt-16 pb-12 px-6 text-center">
        <h1 className="text-[54px] leading-tight font-bold mt-6">
      ...
      {/* 4. Destinations List (Matching Image 3, 4, 5) */}
      <div className="max-w-3xl mx-auto px-6 pb-20">
        ...
        {destinations.map((place) => (
          <div key={place.id} className="mb-24">
            {/* Title */}
            <h2 className="text-[42px] leading-tight font-bold mb-8">
              {place.name}
            </h2>
            ...
            {/* Blue "When to visit" Box (Matching Image 4) */}
            ...
            {/* "Read our Guide" Link (Matching Image 5) */}
