...
// Import your specialized sections
...
const PlanSection = () => {
  // CRITICAL: This must match the category name in your PlanData.jsx exactly
  const [activeTab, setActiveTab] = useState("Planning tools");

  // This filters the 12 items you provided in your PlanData snippet
  ...
  return (
    <div className="w-full bg-white border-t border-gray-100 shadow-2xl animate-in fade-in slide-in-from-top-2 duration-300 z-50 absolute left-0">
      <div className="max-w-7xl mx-auto py-10 px-6">
        ...
        {/* Grid Logic */}
        {activeTab === "Visas and entry" ? (
          <VisasAndEntrySection />
        ) : activeTab === "About India" ? (
          <AboutIndiaSection />
          ...
          /* This block renders your "Planning tools" items by default */
